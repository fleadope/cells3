...
Currently work on cells3 is done on integration branch
http://github.com/mlomnicki/cells3/tree/integration

Basic features are almost finished so it'll be merged to master soon...
